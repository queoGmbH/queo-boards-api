...
namespace Queo.Boards.Core.Tests.Infrastructure {
    ...
    public class PlaceholderRenderContextTest {
        /// <summary>
        ///     Testet das Ersetzen in einem Template, bei dem ein Platzhalter auf ein Child-Property eines Child-Property eines
        ...
        public void TestDeepPathTemplate() {
            ...
            model.Add("user", user);
            string result = new PlaceholderRenderContext().ParseAndRender(TEMPLATE, model);
        ...
        public void TestFormatCulture() {
            ...
            model.Add("today", now);
            /* When: Die Platzhalter ersetzt werden sollen */
            string result = new PlaceholderRenderContext(englishCulture).ParseAndRender(TEMPLATE, model);
        ...
        public void TestFormatPathNotFoundDefaultCustomString() {
            ...
            string result = new PlaceholderRenderContext(DEFAULT_VALUE).ParseAndRender(TEMPLATE, model);
        ...
        public void TestFormatPathNotFoundDefaultStringEmpty() {
            ...
            model.Add("today", now);
            /* When: Das Template ersetzt werden soll */
            string result = new PlaceholderRenderContext(defaultValue).ParseAndRender(TEMPLATE, model);
        ...
        /// <summary>
        ///     Testet getrennte Parsen und nachfolgende Rendern des Templates (also über das Template selbst).
        /// </summary>
        [TestMethod]
        public void TestRenderTemplate() {
            ...
            ITemplate parsedTemplate = new PlaceholderRenderContext().Parse(TEMPLATE);
