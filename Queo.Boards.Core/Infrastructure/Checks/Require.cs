...
namespace Queo.Boards.Core.Infrastructure.Checks {
    /// <summary>
        ...
        public static void IsFalse(Func<bool> expression, string argumentName) {
            ...
            if (expression.Invoke()) {
                throw new ArgumentException(
                    string.Format("Das Argument \"{0}\" erfüllte unerlaubter Weise die Bedingung \"{1}\"!", argumentName, expression), argumentName);
            }
        }
