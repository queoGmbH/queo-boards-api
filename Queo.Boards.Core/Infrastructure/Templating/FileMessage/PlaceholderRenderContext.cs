...
namespace Queo.Boards.Core.Infrastructure.Templating.FileMessage {
    ...
    public class PlaceholderRenderContext:IRenderContext {
        ...
        private readonly ILog _logger = LogManager.GetLogger<PlaceholderRenderContext>();
        ...
        /// </summary>
        public PlaceholderRenderContext() {
        ...
        ///     wird.
        /// </param>
        public PlaceholderRenderContext(string defaultValue)
                : this() {
        ...
        ///     wird.
        /// </param>
        public PlaceholderRenderContext(CultureInfo culture, string defaultValue = null) {
            if (culture == null) {
        ...
        /// <returns></returns>
        public string ParseAndRender(string template, ModelMap model) {
            if (model == null) {
