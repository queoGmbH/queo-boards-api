...
namespace Queo.Boards.Core.Infrastructure.NHibernate.Domain {
    /// <summary>
    ...
    ///     - GetHashCode und Equals korrekt implementieren. Beachten bei GetType, dass da ein Hibernate Proxy dahinter stecken
    ///     kann!!!
    ...
    public class Entity {
        ...
        public override string ToString() {
            string toString = string.Format("{0}: Id: {1}", this.GetType().Name, Id);
            return toString;
        }
    }
}