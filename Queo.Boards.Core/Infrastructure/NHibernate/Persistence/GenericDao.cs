...
namespace Queo.Boards.Core.Infrastructure.NHibernate.Persistence {
    ...
    public class GenericDao<T, TKey> : HibernateDaoSupport, IGenericDao<T, TKey>
        where T : class {
        /// <summary>
        ...
        /// <summary>
        /// Liefert eine Seite für ein QueryOver-Result.
        /// </summary>
        ...
        /// <summary>
        ///     Liefert eine Liste mit Entities entsprechend der Page-Informationen
        ...
        /// <summary>
        ///     Liefert ein Entity anhand seines Primärschlüssels.
        /// </summary>
        /// <param name="primaryKey">Der Primärschlüssel.</param>
        ...
        private static void ApplyPaging(IPageable pageable, ICriteria elementsCriteria) {
